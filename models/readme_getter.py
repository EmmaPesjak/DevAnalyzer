...
class ReadmeGetter:
    ...
    def get_default_branch_name(repo_url):
        ...
        Returns:
            str or None: The default branch name if successful, None otherwise.
        """
    ...
    def extract_readme(self, repo_url):
        ...
        Returns:
            None: Writes the README.md content to a local file if successful, does nothing on failure.
        """
