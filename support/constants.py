...
LOADING_IN_PROG = "Loading is in progress. Are you sure you want to exit? This may cause unexpected behavior."
EXIT_Q = "Do you want to exit the application?"
NO_README_CONTENT = "No README content found."
NO_README = "No README file found in the root."
DB_ERROR = "Was not able to get the repository, please try again, make sure to enter a valid Git " \
